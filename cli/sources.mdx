...
description: "Add URLs, files, YouTube videos, and Google Drive docs to a NotebookLM notebook. Sync stale Drive sources and manage source content."
---
...
| `--title` | | Custom title for the source (required for text sources) |
...
|------|-------|-------------|
| `--json` | `-j` | Output as JSON |
| `--output` | `-o` | Write content to a file instead of stdout |
| `--profile` | `-p` | Profile to use |
...
| Flag | Short | Description |
|------|-------|-------------|
| `--notebook` | `-n` | Notebook ID containing the source (required) |
| `--profile` | `-p` | Profile to use |
