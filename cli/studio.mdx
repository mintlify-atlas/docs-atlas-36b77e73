...
sidebarTitle: "Studio"
description: "Generate podcasts, videos, reports, quizzes, flashcards, mind maps, slides, infographics, and data tables from notebook sources using NotebookLM Studio."
---
...
| `--style-prompt` | | | Custom style description (implies `--style custom` for explainer/brief; maps to focus for cinematic) |
...
| Quiz | `nlm download quiz --format json\|markdown\|html` | varies |
| Flashcards | `nlm download flashcards --format json\|markdown\|html` | varies |
