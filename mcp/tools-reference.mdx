...
sidebarTitle: "Tools"
description: "Full reference for all 39 NotebookLM MCP tools — parameters, types, and example calls organized by category."
---
...
<Accordion title="source_rename — Rename a source">
...
<Accordion title="notebook_query_start — Start an async query">
...
<Accordion title="notebook_query_status — Check async query result">
...
<Accordion title="notebook_share_batch — Invite multiple collaborators">
...
<Accordion title="label — Source label management (unified)">
  ...
  <ParamField body="label_id" type="string">
  ...
  <ParamField body="unlabeled_only" type="boolean" default="false">
