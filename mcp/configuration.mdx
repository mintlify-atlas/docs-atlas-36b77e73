...
The MCP server exposes **35 tools**. Each tool registration consumes a small but non-trivial amount of your AI assistant's context budget, and this cost is paid on every request whether or not you use NotebookLM in that session.
